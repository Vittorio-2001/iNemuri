...
![Banner](./iNemuri_banner_white.svg)
...
- AVFoundation — Audio playback and sound management

- Foundation — Core app logic and alarm scheduling 

- Swift — Primary programming language 

## ⚠️ Important
iNemuri is designed for high-performance visual feedback. Performance may vary depending on the device's hardware capabilities regarding Metal rendering.

## 🔏 Privacy
iNemuri respects your privacy; it operates locally and does not collect, store, or sell personal user data.
